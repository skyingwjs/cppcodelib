...
private:
	...
	void levelTraversal(AVLTreeNode<T>* pnode) const;
...
/*层次遍历*/
template<typename T>
void AVLTree<T>::levelTraversal(AVLTreeNode<T>* pnode) const
{
	if(pnode!=nullptr){
